(function(t, e) { 'object' == typeof exports && 'undefined' != typeof module ? module.exports = e() : 'function' == typeof define && define.amd ? define(e) : t.tippy = e() })(this, function() {
    ...
    function s(t, e, a) {
        ...
        var o = n();
        o.setAttribute('class', 'tippy-tooltip'), o.setAttribute('data-size', a.size), o.setAttribute('data-animation', a.animation), o.setAttribute('data-state', 'hidden'), a.theme.split(' ').forEach(function(e) { o.classList.add(e + '-theme') });
        var r = n();
    ...
    function l(t, e, a, i) {
        ...
        var d = function(t, a) { e.addEventListener(t, a), l.push({ event: t, handler: a }) };
    ...
    function it(t, e, a) {
        var i = W(t, function(t) { var a = t.name; return a === e }),
            o = !!i && t.some(function(t) { return t.name === a && t.enabled && t.order < i.order });
        if (!o) {
            var r = '`' + e + '`';
    ...
    function pt(t, e, a, i) {
        ...
        if ('vh' === p || 'vw' === p) { var l; return l = 'vh' === p ? Ut(document.documentElement.clientHeight, window.innerHeight || 0) : Ut(document.documentElement.clientWidth, window.innerWidth || 0), l / 100 * r }
        return r
    }
    ...
    function nt(t, e, a, i) {
        ...
        return l = l.map(function(t, i) {
            var o = (1 === i ? !r : r) ? 'height' : 'width',
                p = !1;
            return t.reduce(function(t, e) { return '' === t[t.length - 1] && -1 !== ['+', '-'].indexOf(e) ? (t[t.length - 1] = e, p = !0, t) : p ? (t[t.length - 1] += e, p = !1, t) : t.concat(e) }, []).map(function(t) { return pt(t, o, e, a) })
        }), l.forEach(function(t, e) { t.forEach(function(a, i) { tt(a) && (o[e] += a * ('-' === t[i - 1] ? -1 : 1)) }) }), o
    }
        ...
        return {
            ...
            onBlur: function(e) {
                if (!(e.target !== t.reference || qt.usingTouch)) {
                    if (t.options.interactive) { if (!e.relatedTarget) return; if (gt(e.relatedTarget, jt.POPPER)) return }
                    Ot.call(t)
                }
            },
            onDelegateShow: function(e) { gt(e.target, t.options.target) && Lt.call(t, e) },
            onDelegateHide: function(e) { gt(e.target, t.options.target) && Ot.call(t) }
        }
    }
    ...
    function Ct() {
        var t = this,
            ...
            l = Jt({ placement: i.placement }, p || {}, {
                modifiers: Jt({}, p ? p.modifiers : {}, { arrow: Jt({ element: n }, p && p.modifiers ? p.modifiers.arrow : {}), flip: Jt({ enabled: i.flip, padding: i.distance + 5, behavior: i.flipBehavior }, p && p.modifiers ? p.modifiers.flip : {}), offset: Jt({ offset: i.offset }, p && p.modifiers ? p.modifiers.offset : {}) }),
                onCreate: function() { r.style[ct(e)] = ut(i.distance), s && i.arrowTransform && bt(e, s, i.arrowTransform) },
                onUpdate: function() {
                    var t = r.style;
                    t.top = '', t.bottom = '', t.left = '', t.right = '', t[ct(e)] = ut(i.distance), s && i.arrowTransform && bt(e, s, i.arrowTransform)
                }
            });
        return Dt.call(this, { target: e, callback: function() { t.popperInstance.update() }, options: { childList: !0, subtree: !0, characterData: !0 } }), new me(a, e, l)
    }
    ...
    function _t(t, e) {
        return t.reduce(function(t, a) {
            ...
            var h = At.call(n);
            return n.listeners = o.trigger.trim().split(' ').reduce(function(t, e) { return t.concat(l(e, a, h, o)) }, []), o.dynamicTitle && Dt.call(n, {
                target: a,
                callback: function() {
                    var t = m(p),
                        e = t.content,
    ...
    function Nt() {
        var t = function() { qt.usingTouch || (qt.usingTouch = !0, qt.iOS && document.body.classList.add('tippy-touch'), qt.dynamicInputDetection && window.performance && document.addEventListener('mousemove', i), qt.onUserInputChange('touch')) },
            i = function() {
                var t;
                return function() {
    ...
    function Ht(e, a, i) {
        ...
        var p = o(e),
            n = p[0];
        return { selector: e, options: a, tooltips: qt.supported ? _t(i && n ? [n] : p, a) : [], destroyAll: function() { this.tooltips.forEach(function(t) { return t.destroy() }), this.tooltips = [] } }
    }
    var Mt = Math.min,
        Bt = Math.round,
        Wt = Math.floor,
    ...
    var i = Zt && window.Promise,
        ...
        me = function() {
            function t(e, a) {
                ...
                re(this, t), this.scheduleUpdate = function() { return requestAnimationFrame(i.update) }, this.update = ae(this.update.bind(this)), this.options = se({}, t.Defaults, o), this.state = { isDestroyed: !1, isCreated: !1, scrollParents: [] }, this.reference = e && e.jquery ? e[0] : e, this.popper = a && a.jquery ? a[0] : a, this.options.modifiers = {}, Object.keys(se({}, t.Defaults.modifiers, o.modifiers)).forEach(function(e) { i.options.modifiers[e] = se({}, t.Defaults.modifiers[e] || {}, o.modifiers ? o.modifiers[e] : {}) }), this.modifiers = Object.keys(this.options.modifiers).map(function(t) { return se({ name: t }, i.options.modifiers[t]) }).sort(function(t, e) { return t.order - e.order }), this.modifiers.forEach(function(t) { t.enabled && h(t.onLoad) && t.onLoad(i.reference, i.popper, i.options, t, i.state) }), this.update();
                var r = this.options.eventsEnabled;
                r && this.enableEventListeners(), this.state.eventsEnabled = r
            }
            return pe(t, [{ key: 'update', value: function() { return F.call(this) } }, { key: 'destroy', value: function() { return K.call(this) } }, { key: 'enableEventListeners', value: function() { return J.call(this) } }, { key: 'disableEventListeners', value: function() { return $.call(this) } }]), t
        }();
    me.Utils = ('undefined' == typeof window ? global : window).PopperUtils, me.placements = le, me.Defaults = {
        ...
        modifiers: {
            ...
            preventOverflow: {
                ...
                fn: function(t, e) {
                    ...
                    var l = e.priority,
                        d = t.offsets.popper,
                        c = {
                            primary: function(t) { var a = d[t]; return d[t] < s[t] && !e.escapeWithReference && (a = Ut(d[t], s[t])), ne({}, t, a) },
            ...
            hide: {
                ...
                fn: function(t) {
                    ...
                    var e = t.offsets.reference,
                        a = W(t.instance.modifiers, function(t) { return 'preventOverflow' === t.name }).boundaries;
            ...
            applyStyle: {
                order: 900,
                enabled: !0,
                fn: function(t) { return et(t.instance.popper, t.styles), at(t.instance.popper, t.attributes), t.arrowElement && Object.keys(t.arrowStyles).length && et(t.arrowElement, t.arrowStyles), t },
    ...
    if (zt) {
        ...
        fe = he.matches || he.matchesSelector || he.webkitMatchesSelector || he.mozMatchesSelector || he.msMatchesSelector || function(t) { for (var e = (this.document || this.ownerDocument).querySelectorAll(t), a = e.length; 0 <= --a && e.item(a) !== this;); return -1 < a }
    }
    var e = fe,
        be = {},
        ...
        ye = function() {
            ...
            return Qt(t, [{ key: 'enable', value: function() { this.state.enabled = !0 } }, { key: 'disable', value: function() { this.state.enabled = !1 } }, {
                key: 'show',
                value: function(t) {
                    var e = this;
                    if (!this.state.destroyed && this.state.enabled) {
                        ...
                        return o.dynamicTitle && !i.getAttribute('data-original-title') || i.hasAttribute('disabled') ? void 0 : i.refObj || document.documentElement.contains(i) ? void(o.onShow.call(a, this), t = wt(void 0 === t ? o.duration : t, 0), vt([a, n, s], 0), a.style.visibility = 'visible', this.state.visible = !0, St.call(this, function() {
                            if (e.state.visible) {
                                ...
                                vt([n, s, s ? l : null], t), s && getComputedStyle(s)[p('transform')], o.interactive && i.classList.add('tippy-active'), o.sticky && Xt.call(e), xt([n, s], 'visible'), It.call(e, t, function() { o.updateDuration || n.classList.add('tippy-notransition'), o.interactive && kt(a), i.setAttribute('aria-describedby', 'tippy-' + e.id), o.onShown.call(a, e) })
                            }
                        })) : void this.destroy()
                    }
                }
                ...
                value: function() {
                    ...
                    if (!this.state.destroyed) {
                        this.state.visible && this.hide(0), this.listeners.forEach(function(e) { t.reference.removeEventListener(e.event, e.handler) }), this.title && this.reference.setAttribute('title', this.title), delete this.reference._tippy;
        ...
        ge = 1,
        we = !1;
    return Ht.version = '2.5.2', Ht.browser = qt, Ht.defaults = Kt, Ht.one = function(t, e) { return Ht(t, e, !0).tooltips[0] }, Ht.disableAnimations = function() { Kt.updateDuration = Kt.duration = 0, Kt.animateFill = !1 },
        function() {
...
! function(a) { "use strict"; "function" == typeof define && define.amd ? define(["jquery"], a) : "undefined" != typeof module && module.exports ? module.exports = a(require("jquery")) : a(jQuery) }(function(a) {
    var b = -1,
        ...
        e = function(b) {
            ...
            return e.each(function() {
                ...
                null === h ? g.push(b) : Math.floor(Math.abs(f - e)) <= 1 ? g[g.length - 1] = h.add(b) : g.push(b), f = e
            }), g
        },
    ...
    a(window)[i]("load", function(a) { g._update(!1, a) }), a(window)[i]("resize orientationchange", function(a) { g._update(!0, a) })
});;
(function($) {
...
/**
 * @file
 * Tooltip for definition tags.
 */

(function($, Drupal, window, document) {
    Drupal.behaviors.tooltip = {
        attach: function(context, settings) {
            // Process definition tags before Tippy.
            $('dfn').each(function(index) {
                // Add default aria expanded state.
                $(this).attr('aria-expanded', 'false');
                // Add title which Tippy needs to load, which is then removed by Tippy.
                $(this).attr('title', ' ');
                // Copy aria-describedby to data-describedby as Tippy alters it.
                $(this).attr('data-describedby', $(this).attr('aria-describedby'));
            });
            // Add tooltip to definition tags.
            tippy('dfn', {
                theme: 'dark',
                animation: null,
                delay: 150,
                ...
                // Callback when the tooltip is inactive.
                onHidden: function(instance) {
                    var dfn = instance.reference;
                    // Update aria expanded status.
                    $(dfn).attr('aria-expanded', 'false');
                    // Re-instate aria-describedby when Tippy not using it.
                    $(dfn).attr('aria-describedby', $(dfn).attr('data-describedby'));
                },
                // Callback when the tooltip begins to transition in.
                onShow: function(instance) {
                    var dfn = instance.reference;
                    // Update aria expanded status.
                    $(dfn).attr('aria-expanded', 'true');
                    // Get the id of the <dd> tag.
                    var dd_id = "#" + $(dfn).attr('data-describedby');
                    // Set the tooltip's definition.
                    instance.popper.querySelector('.tippy-content').textContent = $(dd_id).text();
                }
            });
        }
    }
...
/**
 * @file
 * Printing options modal at top of page.
 */
...
(function($, Drupal, window, document) {
    Drupal.behaviors.print = {
        attach: function(context, settings) {
            ...
            // Turn all relative links into absolute links.
            ...
            // TODO: Print preview.
            //var config = {
            //  button_id: '#print-button a',
            //  target_id: '#content',
            //  content_types: ['page', 'disease', 'recommendation', 'vaccine'],
            //  print_path: '/sites/default/themes/site/health/css/print.css'
            //}
            //$('#content').printPreview(config);
        }
    }
})(jQuery, Drupal, this, this.document);

// REFERENCE CODE ONLY - NOT USED.
/*
(function($){

  var resizeSmoothly = function () {
  	var timers = {};
  	return function (callback, uid) {
  		if (!timers[uid]) {
  			timers[uid] = setTimeout(callback, 10);
  			setTimeout(function(){
  				timers[uid]= false;
  			}, 12);
  		}
  ...
  dhs_print_package = function(){
    var url = window.location.href;
    var str = url.substr(url.lastIndexOf('/') + 1) + '$';
    var printSourceURI = url.replace( new RegExp(str), '' );
    var printSourceTitle = $("h1:first").text();
  	var dhs_pack = this;

  	dhs_pack.init = function(){
  		if($('link[rel="canonical"]').attr("href")){
  			printSourceURI = $('link[rel="canonical"]').attr("href");
  		}

  		$('body').append(dhs_pack.getPrintTools());
  		$('body').append(dhs_pack.getLinkReferences());
  		$('body').attr('style', 'margin-top: ' + ($('body .printTools').height() + 50 ) + 'px');

  		$('.hide-options, .print-package-heading').click(function(){
  			if ( $('.printTools').hasClass('up') ){
  				$('.print-package-bottom').slideDown(function(){
  					$('body').attr('style', 'margin-top: ' + ($('body .printTools').height() + 50 ) + 'px');
  				});
  				$('.hide-options').html('hide&nbsp;options');
  				$('.printTools').removeClass('up');
  			}else{
  				$('.print-package-bottom').slideUp(function(){
  					$('body').attr('style', 'margin-top: ' + ($('body .printTools').height() + 50 ) + 'px');
  				});
  				$('.hide-options').html('show&nbsp;options');
  				$('.printTools').addClass('up');
  			}
  		});
  		$('.print-links-option input').change(function(){
  			if($('.print-links-option input').prop('checked')){
  				$('.print-ref, .print-links-section').removeClass('hide-more');
  			}else{
  				$('.print-ref, .print-links-section').addClass('hide-more');
  			}
  		});
  		$(window).resize(function () {
  			resizeSmoothly(function(){
  				$('body').attr('style', 'margin-top: ' + ($('body .printTools').height() + 50 ) + 'px');
  			},'winresize')
  		});
  	};

		dhs_pack.generateCheckboxSubLevel = function (a, i, heading_text) {
      return $('<label id="label-for-check-group-' + a + '-' + i + '" for="cb-' + a + '-' + i + '" class="uikit-control-input uikit-control-input--small"><input id="cb-' + a + '-' + i + '" type="checkbox" aria-labelledby="label-for-check-group-' + a + '-' + i + '" class="check-group-' + a + ' uikit-control-input__input" checked="checked"/><span class="uikit-control-input__text">' + heading_text + '</span></label>');
		}

		dhs_pack.generateCheckboxTopLevel = function (a, heading_text) {
			return $('<label id="label-for-check-group-' + a + '" for="cb-' + a + '" class="uikit-control-input uikit-control-input--small"><input id="cb-' + a + '" aria-labelledby="label-for-check-group-' + a + '" title="check-group-' + a + '" type="checkbox" class="check-group-' + a + ' check-group-title uikit-control-input__input" checked="checked" name="check-group-' + a + '"/><span class="uikit-control-input__text">' + heading_text + '</span></label>');
		}

  	dhs_pack.getPrintTools = function () {
  		var printTools, top, col1, col2, col3;
  		var printTools = $('<div class="printTools"/>');
  		var top = $('<div class="print-package-top"/>');
  		var bottom = $('<form class="print-package-bottom"/>');
  		var col1 = $('<div class="w1"/>');
  		var col2 = $('<div class="w2"/>');
  		top.append("<span class='print-package-heading uikit-display-6'>Customise and print this page</span><span class='return-to'>Return to <a href='"+printSourceURI+"' title='Reload original page' id='reload-page'>"+printSourceTitle+"</a> full version</span>");
  		var items = [];
  		var checkbox;
  		$('.print-package-content').each(function(a, obj){

  			$(this).addClass("group-" + a);
  			$(this).addClass("article-" + a);

  			heading = $(this).find('h1, h2, h3, h4').first();

  			var heading_text = 'Untitled section';
  			if (heading.length) {
          heading_text = heading.text();
        }
				checkbox = generateCheckboxTopLevel(a, heading_text);
  			...
  			checkbox.find('input').change(function(){
  				if(this.checked){
  					$(".group-" + a).fadeIn();
  					$("input.check-group-" + a).prop('checked', true);
  				}else{
  					$(".group-" + a).fadeOut();
  					$("input.check-group-" + a).prop('checked', false);
  				}
  				$('.preview-area').hide().fadeIn(function(){
  					dhs_pack.updateLinkReferences();
  				});
  			});
  			var item = $('<li class="title"></li>');
  			item.append(checkbox);
  			items.push(item);

  			$(this).find('.print-section').each(function(i){
  				if ($(this).text().match(/^\s*$/)) {
  					...
  					heading_text = 'Untitled section';
  					if (heading.length) {
              heading_text = heading.text()
  					}
            checkbox = dhs_pack.generateCheckboxSubLevel(a, i, heading_text);
            ...
            // heading.replaceWith(function () {
  					...
  					checkbox.find('input').change(function(){
  						if(this.checked){
  							$(".article-"+a+", .article-"+a+" .section-" +i).fadeIn();
  							$("input.check-group-"+a+".check-group-title").prop('checked', true);
  						}else{
  							$(".article-"+a+" .section-" +i).fadeOut();
  						}
  						$('.preview-area').hide().fadeIn(function(){
  							dhs_pack.updateLinkReferences();
  						});
  		...
  		list1 = $('<ol class="print-selections"/>');
  		list2 = $('<ol class="print-selections"/>');
  		list3 = $('<ol class="print-selections"/>');
  		$.each(items, function(index, item){
  			if(index < (items.length / 3)){
  				list1.append(item);
  			}else if(index < ((items.length / 3)*2)){
  				list2.append(item);
  			}else{
  				list3.append(item);
  			}
  		...
  		col1.append(list2);
  		col1.append(list3);
  		col2.append('<p>Font size <span class="size-indicator">Normal</span></p>');
  		col2.append('<div class="font-size noUiSlider"></div>');

  		col2.append('<label for="plr" class="print-links-option uikit-control-input uikit-control-input--small"><input id="plr" type="checkbox" checked="checked" class="uikit-control-input__input" /><span class="uikit-control-input__text">Print link references</span></label>');
  		bottom.append('<p class="help-inline">Select from the following options to show or hide page sections and customise for printing. When you are finished use the browser print function to print the page.</p>');
  		bottom.append(col1);
  		bottom.append(col2);
  		printTools.append(top);
  		printTools.append(bottom);
  		printTools.append('<a href="javascript:;" class="hide-options">hide&nbsp;options</a>');
  		return printTools;
  	}

  	dhs_pack.updateLinkReferences = function(){
  		$('.print-links-section').replaceWith(dhs_pack.getLinkReferences());
  	}

  	dhs_pack.getLinkReferences = function(){

  		var printLinks = [true],  // first item in the array intentionally not used, so the numbers line up
  			printContainers = '.preview-area :visible', // this is where this script looks for links
  			printIgnore = '.no-print-ref, .navigation, .hidden-print', // if any parent container has this class it will be ignored
  			printLinkMax = 800, // this is the maximum amount of links to check - for speed
  			printLinkExpanded = '', // variables for the script later
  			printLinkExists,
  			printLinkA;
  		$('.print-ref').remove();
  		if ($(printContainers).find('a[href]').length < printLinkMax){

  			$(printContainers).find('a[href]:visible').each(function(){

  				if(!$(this).hasClass('no-print-ref') && !String($(this).attr('href')).match(/^javascript:/) && ($(this).closest(printIgnore).length === 0) && !$(this).hasClass('listen')){

  					printLinkA = this; // so we can refer to it in later loops where _this_ changes

  					if ( ($(this).attr('href').indexOf("#") == 0) || ($(this).attr('href').indexOf(window.location.pathname+'#') != -1 ) ){
  						// we don't want to do anything with an anchor link so change the CSS (no underline for print) and skip it
  						$(this).addClass('anchor');
  						return true; // break out of the each
  					} else if (String($(this).attr('href')).match(/^mailto:/)) {
  						// email address, display differently and strip things like ?subject=
  						printLinkExpanded = 'Email: ' + String($(this).attr('href')).replace(/^mailto:/, '').replace(/\?.*$/, '');
  					} else {
  						// any other link (use .prop to get absolute)
  						printLinkExpanded = $(this).prop('href');
  					}

  					printLinkExists = printLinks.indexOf(printLinkExpanded);

  					if(printLinkExists > 0){
  						// we've already found this link
  						$(printLinkA).after('<sup class="print-ref">[' + printLinkExists + ']<\/sup>');
  					} else {
  						// this is a new link
  						$(printLinkA).after('<sup class="print-ref">[' + printLinks.length + ']<\/sup>');
  						printLinks[printLinks.length] = printLinkExpanded;
  					}
  				}
  			});

  			if (printLinks.length > 1){
  				$printSection = $('<section class="print-links-section" role="complementary"><div class="wrapper"><h2>Link references</h2></section>');
  				$printlinks = $('<ol class="print-links"></ol>');
  				for (var i = 1, j = printLinks.length; i < j; i++) { // purposefully start at 1 to make the numbers line up
  					$printlinks.append('<li>' + String(printLinks[i]).replace(/\//g,'/<span class="linkspacer"></span>') + '</li>');
  				}
  				$printSection.append($printlinks);
  				return $printSection;
  			}
  			return $('<section class="print-links-section" role="complementary"></div></section>'); ;
  		}
  	}
    ...
    $('#plr').change(function(){
      if($(this).prop('checked')) {
          $('.print-links-section, .print-ref').show();
      } else {
          $('.print-links-section, .print-ref').hide();
      }
    });
  }
...
(function($, Drupal, window, document) {
    ...
    Drupal.behaviors.healthMatchHeight = {
        attach: function(context, settings) {
            ...
            // Front page tiles
            $('.block-multiline .bean-block-content a', context).matchHeight();
    ...
    Drupal.behaviors.healthMobileMenu = {
        attach: function(context, settings) {
            ...
            $('.mobile-toggle.mobile-toggle--main-menu', context).click(function(e) {
                ...
                // If Search was open then close it, otherwise activate the overlay.
                if ($('.mobile-toggle.mobile-toggle--search').hasClass("active")) {
                    $('.mobile-toggle.mobile-toggle--search').toggleClass("active");
            ...
            $('.mobile-toggle.mobile-toggle--search', context).click(function(e) {
                $(this).toggleClass('active');
                $('#block-search-api-page-default-search--2').toggleClass("active");
                // If Menu was open then close it, otherwise activate the overlay.
                if ($('.mobile-toggle.mobile-toggle--main-menu').hasClass("active")) {
                    $('.mobile-toggle.mobile-toggle--main-menu').toggleClass("active");
                    $('#block-superfish-1').toggleClass("active");
                } else {
                    $('.nav-overlay').toggleClass("active");
                }
            ...
            $('.nav-overlay', context).click(function() {
                // Deactivate menu if it is currently active.
                if ($('.mobile-toggle.mobile-toggle--main-menu', context).hasClass('active')) {
                    $('.mobile-toggle.mobile-toggle--main-menu').trigger('click');
                }
                // Deactivate search if it is currently active.
                if ($('.mobile-toggle.mobile-toggle--search', context).hasClass('active')) {
            ...
            $('.mobile-toggle.mobile-toggle__local-nav a', context).click(function(e) {
                e.preventDefault();
                $("#block-menu-block-6", context).toggleClass('mobilemenu-active');
    ...
    // Add ids to headings (if anchorific is loaded).
    Drupal.behaviors.addHeaderIds = {
        attach: function(context, settings) {
            if (typeof $().anchorific === "function") {
    ...
    // Expand an accordion when it is linked to.
    Drupal.behaviors.hashLink = {
        attach: function(context, settings) {
            hashOpen(context);
    ...
    Drupal.behaviors.healthAccordionExpandCollapse = {
        attach: function(context, settings) {
            $('.health-accordion-group .expand-all', context).click(function(e) {
                $(this).parents('.health-accordion-group').find('a.health-accordion__title.health-accordion--closed').click();
            });
            $('.health-accordion-group .collapse-all', context).click(function(e) {
                $(this).parents('.health-accordion-group').find('a.health-accordion__title.health-accordion--open').click();
            });
        }
    }

    function hashOpen(context) {
        var hash = window.location.hash;
        if (!hash.length) {
            return;
        }
        // Check if the fragment is a heading element.
        var tags = ['h2', 'h3', 'h4', 'h5', 'h6'];
        $.each(tags, function(index, value) {
            // Is the fragment a heading inside a collapsible?
            var element = $('body', context).find(value + hash);
            if (element.length) {
                // locate the parent accordion header.
                var parent = element.parents('.health-accordion');
                if (parent.length) {
                    $(parent.children('a.health-accordion__title.health-accordion--closed')).click();
                }
                return false;
            }
        });
...
var UIKIT = UIKIT || {};
! function(e) {
    function t(e, t, n) { "closing" === n ? (t.setAttribute("aria-hidden", !0), e.setAttribute("aria-expanded", !1), e.setAttribute("aria-selected", !1)) : (t.setAttribute("aria-hidden", !1), e.setAttribute("aria-expanded", !0), e.setAttribute("aria-selected", !0)) }

    function n(e, t, n, a) {
        if ("opening" === t || "open" === t) var r = n || "uikit-accordion--closed",
            l = a || "uikit-accordion--open";
        else var r = a || "uikit-accordion--open",
            l = n || "uikit-accordion--closed";
        o(e, r), i(e, l)
    }

    function o(e, t) { e.classList ? e.classList.remove(t) : e.className = e.className.replace(new RegExp("(^|\\b)" + t.split(" ").join("|") + "(\\b|$)", "gi"), " ") }

    function i(e, t) { e.classList ? e.classList.add(t) : e.className = e.className + " " + t }
    var a = {};
    a.Toggle = function(o, i, a) {
        try { window.event.cancelBubble = !0, event.stopPropagation() } catch (e) {}
        void 0 === o.length && (o = [o]), "object" != typeof a && (a = {});
        for (var r = 0; r < o.length; r++) {
            var l = o[r],
                c = l.getAttribute("aria-controls"),
                s = document.getElementById(c);
            if (null == s) throw new Error("UIKIT.animate.Toggle cannot find the target to be toggled from inside aria-controls");
            s.style.display = "block",
                function(o) { e.animate.Toggle({ element: s, property: "height", speed: i || 250, prefunction: function(e, i) { "opening" === i ? (e.style.display = "block", "function" == typeof a.onOpen && a.onOpen()) : "function" == typeof a.onClose && a.onClose(), t(o, e, i), n(o, i) }, postfunction: function(e, t) { "closed" === t ? (e.style.display = "", "function" == typeof a.afterOpen && a.afterClose()) : "function" == typeof a.afterClose && a.afterOpen(), n(e, t) } }) }(l)
        }
        return !1
    }, a.Open = function(o, i) {
        try { window.event.cancelBubble = !0, event.stopPropagation() } catch (e) {}
        ...
        for (var a = 0; a < o.length; a++) {
            var r = o[a],
                ...
                s = 0;
            s = "undefined" != typeof getComputedStyle ? window.getComputedStyle(c).height : c.currentStyle.height, 0 === parseInt(s) && (c.style.height = "0px"), c.style.display = "", n(c, "opening"), n(r, "opening"), t(r, c, "opening"),
                function(t, o, i) { e.animate.Run({ element: t, property: "height", endSize: "auto", speed: o || 250, callback: function() { n(i, "opening") } }) }(c, i, r)
        }
    }, a.Close = function(o, i) {
        try { window.event.cancelBubble = !0, event.stopPropagation() } catch (e) {}
        void 0 === o.length && (o = [o]);
        for (var a = 0; a < o.length; a++) {
            var r = o[a],
                l = r.getAttribute("aria-controls"),
                c = document.getElementById(l);
            n(r, "closing"), t(r, c, "closing"),
                function(t, o) { e.animate.Run({ element: t, property: "height", endSize: 0, speed: o || 250, callback: function() { t.style.display = "none", n(t, "close") } }) }(c, i)
        }
    }, e.accordion = a
}(UIKIT), "undefined" != typeof module && (module.exports = UIKIT);
var UIKIT = UIKIT || {};
! function(e) {
    function t(e, t, n) {
        ...
        var o = t - e,
            ...
            a = o < 0 ? -1 : 1,
            r = Math.abs(o / a);
        return i = n / r, Math.abs(i) < 1e3 / 60 && (i = 1e3 / 60, r = Math.ceil(Math.abs(n / i)), a = o / r), { stepSize: a, steps: r - 1, intervalTime: i }
    }
    var n = {};
    "undefined" != typeof module && (n.CalculateAnimationSpecs = t), n.GetCSSPropertyBecauseIE = function(t, n) { if ("undefined" != typeof getComputedStyle) return window.getComputedStyle(t)[n]; var o = t.currentStyle[n]; return "auto" === o && (o = e.animate.CalculateAuto(t, n)), o }, n.CalculateAuto = function(e, t) { var n, o; return "height" === t ? (n = e.clientHeight, e.style[t] = "auto", o = e.clientHeight, e.style[t] = n + "px") : (n = e.clientWidth, e.style[t] = "auto", o = e.clientWidth, e.style[t] = n + "px"), parseInt(o) }, n.Stop = function(e) { clearInterval(e.UIKITanimation) }, n.Run = function(n) {
        var o = n.element,
            i = n.speed || 250;
        void 0 === o.length && (o = [o]), "function" != typeof n.callback && (n.callback = function() {}), o[0].UIKITinteration = 0, o[0].UIKITinterations = o.length;
        for (var a = 0; a < o.length; a++) {
            var r = o[a];
            e.animate.Stop(r);
            var l = parseInt(e.animate.GetCSSPropertyBecauseIE(r, n.property)),
                c = n.endSize;
            "auto" === n.endSize && (c = e.animate.CalculateAuto(r, n.property));
            var s = t(l, c, i),
                p = l;
            s.stepSize < 0 ? r.UIKITtoggleState = "closing" : s.stepSize > 0 && (r.UIKITtoggleState = "opening"),
                function(t, i, a, r, l) { t.UIKITanimation = setInterval(function() { if (i === l || 0 === r.steps) { if (e.animate.Stop(t), t.style[n.property] = l + "px", t.UIKITtoggleState = "", o[0].UIKITinteration++, "auto" === n.endSize && (t.style[n.property] = ""), o[0].UIKITinteration >= o[0].UIKITinterations) return n.callback() } else a += r.stepSize, t.style[n.property] = a + "px", r.steps-- }, Math.abs(r.intervalTime)) }(r, l, p, s, c)
        }
    }, n.Toggle = function(t) {
        var n = t.element,
            o = t.property || "height",
            ...
            a = t.closeSize || 0,
            r = t.openSize || "auto";
        void 0 === n.length && (n = [n]), "function" != typeof t.prefunction && (t.prefunction = function() {}), "function" != typeof t.postfunction && (t.postfunction = function() {}), "function" != typeof t.callback && (t.callback = function() {}), n[0].UIKITtoggleInteration = 0, n[0].UIKITtoggleInterations = n.length;
        for (var l = 0; l < n.length; l++) {
            ...
            if (f === a || "closing" === c.UIKITtoggleState) s = r, p = "opening", u = "open";
            else {
                if (f === a && "opening" !== c.UIKITtoggleState) throw new Error("UIKIT.animate.Toggle cannot determine state of element");
                s = a, p = "closing", u = "closed"
            }
            t.prefunction(c, p), e.animate.Run({
                element: c,
                endSize: s,
                property: o,
                speed: i,
                callback: function() {
                    if (++n[0].UIKITtoggleInteration === n[0].UIKITinterations) { var e = t.callback(c, u); return t.postfunction(c, u), e }
                    t.postfunction(c, u)
                }
            })
        }
